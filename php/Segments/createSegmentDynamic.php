...
/**
 * Ce script permet de créer un Segment Dynamique.
 *
 * @package cookbook
 */
 ...
 * @var string
 */
$name = 'SegmentDynamic (php)';
/**
 * Description du segment.
 *
 * @var string
 */
$description = 'SegmentDynamic (php)';
/**
...
if ($con['info']['http_code'] == 200) {
  ...
  echo 'The segment dynamic  : ' . $name . " has been created / updated.\n\n";
}
else {
