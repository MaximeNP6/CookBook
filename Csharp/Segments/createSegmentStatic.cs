...
namespace createSegmentStatic
{
	internal class Program
	{
		private static void Main(string[] args)
		{
			...
			var type = "static";	//Code pour creer un segment Statique
			var name = "SegmentStatic (Csharp)";	//Nom du segment
			var description = "SegmentStatic (Csharp)";	//Description du segment
			var expiration = "2016-08-08T12:11:00Z";	//Date d'expiration du segment
