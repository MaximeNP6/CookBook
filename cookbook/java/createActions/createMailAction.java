...
public class createMailAction {
    public static void main(String[] args) throws IOException, JSONException, InterruptedException {
        ...
        String type = "mailMessage";    //Code pour envoyer un mail
        String name = "MailFromApi (java)";    //Nom de l'action
        String description = "MailFromApi (java)";    //Description de l'action

        Integer informationFolder = 1234;    //Id du dossier dans lequel vous voulez mettre l'action ('null' pour aucun dossier)
        Integer informationCategory = 1234;    //Id de la categorie de campagne (Infos compte > Parametrage > Categories de campagnes)
